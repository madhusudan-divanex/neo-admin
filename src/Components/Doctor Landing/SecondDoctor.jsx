...
function SecondDoctorPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await securePostData("api/admin/landing/second-doctor-page", form);
            if (res.success) {
                fetchData()
            }
                ...
                <div className="new-mega-card p-4">
                    ...
                    {form.model.map((item, index) => (
                        <div className="row my-3" key={index}>
                            ...
                            <div className="col-lg-12">
                                <div className="custom-frm-bx">
                                    <label htmlFor="">Points (seperated by full stop)</label>
                                    <input
                                        className="form-control nw-select-frm"
                                        placeholder=""
...
export default SecondDoctorPage;