...
function ScheduleMedicines() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res =editingId?await updateApiData('admin/schedule-medicines',data) : await securePostData(
                "admin/schedule-medicines",
                data
            );
    ...
    const fetchData = async () => {
        try {
            const res = await getApiData("admin/schedule-medicines");
    ...
    const handleDelete = async (id) => {
        try {
            const res=await deleteApiData(`admin/hospital-category/${id}`);
            if(res?.success){
    ...
    return (
        <div className="main-content flex-grow-1 p-3 overflow-auto">
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h3 className="gradient-text">Schedule Medicines</h3>
