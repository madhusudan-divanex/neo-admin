                        ...
                        <div className="dropdown">
                          ...
                          <ul className="dropdown-menu dropdown-menu-end mt-2 admin-dropdown-card">
                            <li className="prescription-item">
                              <NavLink to={`/lab-info-details/${item.userId || item._id}`} className="prescription-nav">View Details</NavLink>
                            </li>
                            {(item.status === "pending" || item.status === "verify") && <>
                              ...
                              <li className="prescription-item">
                                <a className="prescription-nav reject-title" href="#"
                                  data-bs-toggle="modal" data-bs-target="#laboratoryRejectModal"
