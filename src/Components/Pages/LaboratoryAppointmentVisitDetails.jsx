...
function LaboratoryAppointmentVisitDetails() {
  return (
     <>
                                ...
                                <div className="neo-health-user-information d-flex align-items-start justify-content-between my-3">
                                    <div className="">
                                        ...
                                        <div className="mb-3">
                                         ...
                                         <div className="mb-3">
                                            <h6>Status</h6>
                                            <p><span className="approved approved-visited ">Visited</span></p>
                                        </div>
                                    </div>
                                    </div>
                               ...
                               <div className="neo-health-patient-info-card mb-3">
                                ...
                                <div className=" my-3">
                                    ...
                                    <div className="d-flex align-items-center justify-content-between mb-2">
                                        ...
                                        <div>
                                            <p><span className="approved approved-active  rounded-5 px-3 py-2">Paid</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default LaboratoryAppointmentVisitDetails