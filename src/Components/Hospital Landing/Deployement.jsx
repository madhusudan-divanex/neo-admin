...
function DeployementHospitalPage() {
    ...
    // ─── Validate ─────────────────────────────────────────────────────────────
    const validate = () => {
        if (!form.deployment.title) return "Deployment: Title required";
        if (!form.deployment.description) return "Deployment: Description required";
        return null;
    };
        ...
        try {
            ...
            setForm({
                deployment: {
                    ...
                    feature: data.deployment?.feature?.length
                        ? data.deployment.feature
    ...
    return (
        <div className="main-content flex-grow-1 p-3 overflow-auto">
            <form onSubmit={handleSubmit}>
                ...
                <h3 className="gradient-text mb-3">Deployment</h3>
                        ...
                        <div className="col-lg-6">
                            <div className="custom-frm-bx">
                                ...
                                <input
                                    ...
                                    value={form.deployment.title}
                                    onChange={(e) => handleFieldChange("deployment", "title", e.target.value)}
                                />
                            </div>
                        </div>
                        ...
                        <div className="col-12">
                            <div className="custom-frm-bx">
                                ...
                                <textarea
                                    ...
                                    value={form.deployment.description}
                                    onChange={(e) => handleFieldChange("deployment", "description", e.target.value)}
                                />
                            </div>
                        </div>
                    </div>

                    <FeatureBlock section="deployment" />
                </div>
...
export default DeployementHospitalPage;