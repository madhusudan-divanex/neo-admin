...
function ThirdLabPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await securePostData("api/admin/landing/third-lab-page", formData);
            if (res.success) {
                fetchData()
            }
    ...
    return (
        <div className="main-content flex-grow-1 p-3 overflow-auto">
            {/* <h3 className="gradient-text mb-3">Laboratory Landing Page</h3> */}
                <h4 className="ms-4">Core Laboratory Capabilities</h4>
