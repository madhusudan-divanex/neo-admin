...
function SixLabPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await securePostData("api/admin/landing/six-lab-page", formData);
            if (res.success) {
                fetchData()
            }
    ...
    const fetchData = async () => {
        try {
            ...
            const data = res.data?.sixSection;
            if (!data) return;
    ...
    return (
        <div className="main-content flex-grow-1 p-3 overflow-auto">
            ...
            <h4 className="ms-4">Ecosystem Analytics</h4>
                ...
                <div className="new-mega-card p-4">
                    ...
                    {form.model.map((item, index) => (
                        <div className="row mt-3" key={index}>
                            ...
                            <div className="col-lg-3">
                                <div className="custom-frm-bx">
                                    {/* <label htmlFor="">Points (seperated by comma)</label> */}
                                    <input
                                        rows={10}
                                        className="form-control nw-select-frm"
