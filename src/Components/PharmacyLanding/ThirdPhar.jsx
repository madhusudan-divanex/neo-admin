...
function ThirdPharPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const data = {title:form?.title,model:JSON.stringify(form.model)};

         
            const res = await securePostData("api/admin/landing/third-phar-page", data);
            if (res.success) {
                fetchData()
            }
                        ...
                        <div className="row mt-3" key={index}>
                             ...
                             <div className="col-lg-3">
                                <input
                                    ...
                                    value={item.number}
                                    onChange={(e) =>
                                        handleModelChange(index, "number", e.target.value)
                                    }
                                />
                            </div>
