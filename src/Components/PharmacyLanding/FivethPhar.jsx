...
function FivethPharPage() {
    ...
    const validate = () => {
        ...
        if (!form.usageRule) return "Usages Rule is required";
        return null;
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formData.append("usageRule", form.usageRule);
            ...
            const res = await securePostData("api/admin/landing/fiveth-phar-page", formData);
            if (res.success) {
                fetchData()
            }
                ...
                <div className="new-mega-card p-4">
                    ...
                    <button type="button" onClick={addModule} className="mt-3">
                     ...
                     <div className="col-12 mt-5">
                            <div className="custom-frm-bx">
                                <label>NeoAI usage rule</label>
                                <textarea
                                    className="form-control nw-select-frm"
                                    rows={4}
                                    value={form.usageRule}
                                    onChange={(e) =>
                                        handleChange("usageRule", e.target.value)
                                    }
                                />
                            </div>
                        </div>
