...
function PtServices() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formData.append("btnLink", form.btnLink);
            ...
            // ✅ EDIT CASE
            if (editingId) {
                formData.append("serviceId", editingId);
            }

            const res = await securePostData(
                "api/admin/landing/patient-service",
                formData
            );
    ...
    const fetchData = async () => {
        try {
            ...
            const data = res.data?.ptServices;
            setWorkData(data)
            if (!data) return;
    ...
    const handleDelete = async (id) => {
        try {
            const res=await deleteApiData(`api/admin/landing/patient-service/${id}`);
            if(res?.success){
