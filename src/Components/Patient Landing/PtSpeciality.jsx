...
function PtSpeciality() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res =editingId?await updateApiData('admin/speciality',formData) : await securePostData(
                "admin/speciality",
                formData
            );
    ...
    const fetchData = async () => {
        try {
            ...
            const data = res.data?.speciality;
            setWorkData(data)
            if (!data) return;
    ...
    const handleDelete = async (id) => {
        try {
            const res=await deleteApiData(`admin/speciality/${id}`);
            if(res?.success){
    ...
    return (
        <div className="main-content flex-grow-1 p-3 overflow-auto">
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h3 className="gradient-text">Doctor Speciality</h3>
