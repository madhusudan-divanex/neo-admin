...
function HospitalCategory() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res =editingId?await updateApiData('admin/hospital-category',formData) : await securePostData(
                "admin/hospital-category",
                formData
            );
    ...
    const fetchData = async () => {
        try {
            const res = await getApiData("admin/hospital-category");
    ...
    return (
        <div className="main-content flex-grow-1 p-3 overflow-auto">
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h3 className="gradient-text">Hospital Categories</h3>
