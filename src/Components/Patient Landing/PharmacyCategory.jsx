...
function PharmacyCategory() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res =editingId?await updateApiData('admin/pharmacy-category',formData) : await securePostData(
                "admin/pharmacy-category",
                formData
            );
    ...
    const fetchData = async () => {
        try {
            const res = await getApiData("admin/pharmacy-category");
    ...
    const handleDelete = async (id) => {
        try {
            const res=await deleteApiData(`admin/pharmacy-category/${id}`);
            if(res?.success){
    ...
    return (
        <div className="main-content flex-grow-1 p-3 overflow-auto">
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h3 className="gradient-text">Pharmacy Categories</h3>
