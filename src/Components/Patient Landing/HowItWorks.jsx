...
function HowItWorkPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // ✅ EDIT CASE
            if (editingId) {
                formData.append("workId", editingId);
            }

            const res = await securePostData(
                "api/admin/landing/patient-how-it-works",
                formData
            );
    ...
    const fetchData = async () => {
        try {
            ...
            const data = res.data?.howItWorks;
            setWorkData(data)
            if (!data) return;
    ...
    const handleDelete = async (id) => {
        try {
            const res=await deleteApiData(`api/admin/landing/patient-how-it-works/${id}`);
            if(res?.success){
    ...
    return (
        <div className="main-content flex-grow-1 p-3 overflow-auto">
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h3 className="gradient-text">How It Works</h3>
                ...
                <div className="new-mega-card p-4">
                    ...
                    {workData?.map((item) => (
                        <div className="row mt-3 align-items-center" key={item._id}>
                            ...
                            <div className="col-lg-2">{item.title}</div>
