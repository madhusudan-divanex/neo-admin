                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12">
                                <div className="custom-frm-bx">
                                    ...
                                    <input type="text" name="name"
                                        value={form.name}
                                        onChange={handleChange} className="form-control new-control-frm" placeholder="Enter Pharmacy Name " />
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12">
                                <div className="custom-frm-bx">
                                    <label>About</label>
                                    <input type="text" className="form-control new-control-frm" placeholder="Enter about pharmacy"
                                        name="about"
                                        value={form.about}
